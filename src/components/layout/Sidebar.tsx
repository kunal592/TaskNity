    ...
    <>
      ...
      <AnimatePresence>
        {open && (
          ...
          >
            <div className="p-5 mt-12 flex-1 overflow-y-auto">
              <h2 className="text-xl font-bold tracking-tight text-primary mb-6">TaskNity.Work</h2>
              ...
              {isAuthenticated && user ? (
                <div className="flex items-center gap-3">
                  <div className="flex-grow">
                    ...
                    <p className={`text-xs font-medium ${roleColors[user.role] || 'text-muted-foreground'}`}>
                      {user.role}
                    </p>
                  </div>
